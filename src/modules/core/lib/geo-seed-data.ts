/**
 * @fileoverview Official geographic data seed for Costa Rica.
 * Includes all 7 provinces, 82 cantons, and their respective districts.
 */

export const COSTA_RICA_GEO_DATA = {
	"provincias": {
		"1": {
			"nombre": "San José",
			"cantones": {
